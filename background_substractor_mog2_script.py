...
Motion detector Example (Using the algorithm "Backgroudn substraction")
Note: This tests have been applied using the camera integrated on the computer and using Ubuntu 17.10
"""


cam = cv2.VideoCapture(0)
bs = cv2.createBackgroundSubtractorMOG2(history=500, varThreshold=50, detectShadows=False)
